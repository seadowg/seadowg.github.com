...
Once you've tapped sync and the files have all been moved, you'll be prompted to eject the drive by swiping down from the top of the screen and tapping "Eject". It is recommended you do this. Otherwise, there's a risk that the changes to the USB drive (either files being added or deleted) will not be "committed" and you could end up losing something.
